...
<div id="content">
    ...
    <a href="./jugador/1">
            <figure class="playersTeam">
                <img src="public/images/lonzo-ball.jpg" />
                <figcaption>Lonzo Ball</figcaption>
            </figure>
        </a>
        <a href="./jugador/2">
            <figure class="playersTeam">
            <img src="public/images/lebron-james.jpg" />
                <figcaption>Lebron James</figcaption>
            </figure>
        </a>
        <a href="./jugador/3">
            <figure class="playersTeam">
                <img src="public/images/kyle-kuzma.jpg" />
                <figcaption>Kyle Kuzma</figcaption>
            </figure>
        </a>
        <a href="./jugador/4">
            <figure class="playersTeam">
                <img src="public/images/brandon-ingram.jpg" />
                <figcaption>Brandon Ingram</figcaption>
            </figure>
        </a>
        <a href="./jugador/5">
            <figure class="playersTeam">
                <img src="public/images/javale-mcgee.jpg" />
